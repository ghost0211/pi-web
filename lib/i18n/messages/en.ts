...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "common.about": "About",
    "about.title": "About",
    "about.description": "Pi Web and Pi Agent runtime version information, update checks, and open source repository.",
    "about.appInfo": "Application Info",
    "about.appEditionDesktop": "Desktop Edition",
    ...
    "about.cliNotInstalled": "Global CLI not detected",
    "about.statusChecking": "Checking for updates…",
    "about.statusUpToDate": "Up to date",
    "about.statusUpdateAvailable": "New version available: {version}",
    "about.statusCheckFailed": "Failed to check for updates",
    "about.checkUpdates": "Check for Updates",
    "about.desktopUpdateTitle": "Desktop updates",
    "about.desktopUpdateAvailable": "Version {version} is available",
    "about.desktopUpdateNotChecked": "Desktop updates have not been checked yet",
    "about.desktopInstallUpdate": "Download and install update",
    "about.desktopDownloading": "Downloading update {progress}",
    "about.desktopInstalling": "Installing update…",
    "about.desktopUpdateRestartNote": "Installation exits Desktop and interrupts active sessions.",
    "about.desktopUpdateConfirm": "Install Desktop v{version}? The app will exit and interrupt active sessions.",
    "about.desktopUpdateError": "Update check or installation failed: {error}",
    "about.updatePiAgent": "Update Pi Agent",
    "about.updating": "Updating…",
    "about.updateSuccess": "Update successful!",
    "about.updateSuccessDetail": "Pi Agent has been updated to {version}. Restarting the application is recommended.",
    "about.updateFailed": "Update failed",
    "about.updateOutput": "Update Log",
    "about.updateScopeGlobal": "Global CLI (npm -g)",
    "about.updateScopeLocal": "Local Dependencies",
    "about.updateTargetLabel": "Update Target",
    "about.repoInfo": "Repository & Open Source",
    "about.githubRepo": "GitHub Repository",
    "about.releases": "Releases",
    "about.issues": "Issues & Feedback",
    ...
    "settings.fontSizeDescription": "Adjust the text font size across conversations and interfaces.",
    "settings.fontSizeSmall": "Small",
    "settings.fontSizeMedium": "Default",
    "settings.fontSizeLarge": "Large",
    "settings.fontSizeXLarge": "Extra Large",
    "settings.hideThinking": "Collapse thinking by default",
    "settings.hideThinkingDescription": "Automatically collapse reasoning blocks to keep the conversation concise.",
    "settings.autoCompaction": "Auto Context Compaction",
    "settings.autoCompactionDescription": "Automatically summarize older context when approaching the token limit.",
    "settings.autoRetry": "Auto Retry on Failure",
    "settings.autoRetryDescription": "Automatically retry requests when encountering network flakes or transient errors.",
    "settings.quietStartup": "Quiet Startup",
    "settings.quietStartupDescription": "Suppress verbose informational notices on session startup.",
    "settings.defaultReasoning": "Default Reasoning Level",
    "settings.defaultReasoningDescription": "Initial reasoning/thinking level for newly created sessions.",
    "settings.projectTrust": "Project Trust Policy",
    ...
    "settings.desktopTailnetHint": "To reach it from your phone, run this once on this PC with Tailscale installed. Serve is tailnet-only; never use Funnel for an unauthenticated agent server. See desktop/README.md for hostname and security setup.",
    "settings.closeBehaviorTray": "Minimize to system tray",
    "settings.closeBehaviorQuit": "Quit the app",
    "settings.enableSkillCommands": "Enable Skill Slash Commands",
    "settings.enableSkillCommandsDescription": "Allow discovering and invoking skills via / in the composer.",
    ...
    "settings.modelScope": "Model scope",
    "modelScope.description": "Choose which models appear in the session model selector (/model). Until a selection is saved, every available model is offered; once saved, models from providers connected later stay unselected until you check them here. Saving with everything checked clears the restriction.",
    "modelScope.takeEffect": "Applies to new sessions; running sessions pick it up after a reload.",
    "modelScope.searchPlaceholder": "Search models…",
    "modelScope.selectAll": "Select all",
    "modelScope.clear": "Clear",
    "modelScope.save": "Save",
    "modelScope.saving": "Saving…",
    "modelScope.saved": "Saved",
    "modelScope.emptySaveHint": "Keep at least one model selected",
    "modelScope.loading": "Loading models…",
    "modelScope.noModels": "No models available",
    "modelScope.unavailable": "Temporarily unavailable",
    "modelScope.loadError": "Failed to load the model list",
    "modelScope.saveError": "Failed to save",
    "modelScope.selectedCount": "{selected}/{total} selected",
    "settings.projectRequired": "Open a project to configure this section",
    "settings.hiddenProjectsDescription": "Projects hidden from the session sidebar. Restore a project to show its sessions again.",
    "settings.noHiddenProjects": "No hidden projects.",
    "settings.restoreProject": "Restore",
    "settings.selectHiddenProject": "Select a hidden project to manage its sessions.",
    "settings.noSessionsForProject": "No sessions found for this project.",
    "settings.sessionHidden": "hidden",
    "settings.restoreSession": "Restore",
    "settings.removeProjectPermanently": "Remove project",
  ...
  "history.openHtml": "Open HTML",
  "history.downloadHtml": "Download HTML",
  "history.downloadJsonl": "Download JSONL",
    ...
    "system.label": "System",
  "system.customTitle": "Session override",
  "system.customMode.append": "Append",
  "system.customMode.replace": "Replace",
  "system.customAdd": "Add override",
  "system.customEdit": "Edit",
  "system.customSave": "Save",
  "system.customClear": "Clear",
  "system.customCancel": "Cancel",
  "system.customPlaceholder": "Additional instructions for this session…",
  "system.customEmpty": "Override text cannot be empty",
    "tools.label": "Tools",
  ...
  "sidebar.importSession": "Import session (.jsonl)",
    ...
    "sidebar.deleteSession": "Hide {title}?",
    "sidebar.hideSession": "Hide session",
    "sidebar.hideSessionShiftClick": "Hide (Shift+click to hide without confirmation)",
    "sidebar.today": "Today",
    "sidebar.yesterday": "Yesterday",
    "sidebar.last7Days": "Previous 7 Days",
    "sidebar.earlier": "Earlier",
    "sidebar.sessionsHeading": "SESSIONS",
    "sidebar.collapseAll": "Collapse all workspaces",
    "sidebar.expandAll": "Expand all workspaces",
    "sidebar.manageList": "List management",
    "sidebar.searchSessions": "Search sessions...",
    "sidebar.projectOptions": "Options",
    "sidebar.newSessionHere": "New session here",
    "sidebar.copyPath": "Copy path",
    "sidebar.removeFromList": "Hide project",
    "sidebar.hideProject": "Hide project",
    "sidebar.removeProjectPermanently": "Remove project permanently",
    "sidebar.hiddenProjects": "Hidden projects",
    "sidebar.noMatchingSessions": "No matching sessions found",
    "sidebar.openDirectory": "Open local directory...",
    "sidebar.allProjects": "Projects",
    "sidebar.newInProject": "New session in this project",
    "sidebar.rename": "Rename",
    "sidebar.delete": "Hide",
    "sidebar.deleteWithShiftClick": "Hide (Shift+click to hide without confirmation)",
    ...
    "files.openWithSystem": "Open with the system default app",
    "files.openOptions": "More open options",
    "files.openWithOther": "Open with another app…",
    "files.revealInExplorer": "Show in file manager",
    "files.copyFullPath": "Copy full path",
    "files.copyPathFailed": "Could not copy the path",
    "files.openFileFailed": "Could not open the file: {error}",
    ...
    "chat.turnOutcome": "Turn results",
    "chat.recordedCommands": "Commands run ({count})",
    "chat.commandFailures": "Some commands failed",
    "chat.command.completed": "Completed",
    "chat.command.failed": "Failed",
    "chat.command.unknown": "No result recorded",
    "chat.commandOutputTail": "Showing the last 4,000 characters. Full output is in process details.",
  ...
  "chat.customTools": "Custom",
  "chat.customizeTools": "Customize…",
  "chat.customToolsBack": "Back to presets",
  "chat.customToolsNone": "No tools selected — same as Chat only",
  "chat.ephemeral": "Ephemeral",
  "chat.ephemeralHint": "In-memory session: nothing is written to disk",
    ...
    "chat.commandClear": "Clear and start a fresh session",
    "chat.commandModel": "View or switch the active model",
    "chat.commandThinking": "Set reasoning level (auto/off/low/medium/high)",
    "chat.commandTools": "Set tool preset mode",
    "chat.commandSettings": "Open settings panel",
    "chat.commandHelp": "View available commands and help",
  ...
  "i18n.searchBranches": "Search branches…",
  "i18n.labeledOnly": "Show bookmarks only",
  "i18n.addLabel": "Add bookmark",
  "i18n.editLabel": "Edit bookmark",
  "i18n.labelPlaceholder": "Bookmark name…",
  "i18n.saveLabel": "Save",
  "i18n.noLabels": "No bookmarks yet",
    "i18n.source": "Source",
    ...
    "dock.bash": "Background Bash",
    "dock.agent": "Sub-agent",
    ...
    "dock.failed": "Failed",
    "dock.queued": "Queued",
    "dock.noBash": "No background Bash tasks in this session",
    "dock.noAgent": "No background agents",
    "dock.noProgress": "No plan tasks",
    "dock.copy": "Copy",
    "sidebar.showMore": "Show more",
    "sidebar.showLess": "Show less",
    "chat.contextUsage": "Context Usage",
    "chat.contextTokens": "Token Usage",
    "chat.inputTokens": "Input tokens",
    "chat.outputTokens": "Output tokens",
    "chat.cacheTokens": "Cache read",
