...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "common.about": "关于",
    "about.title": "关于",
    "about.description": "Pi Web 与 Pi Agent 运行时版本信息、更新检测及开源项目。",
    "about.appInfo": "应用信息",
    ...
    "about.cliNotInstalled": "未检测到全局 CLI",
    "about.statusChecking": "正在检查更新…",
    "about.statusUpToDate": "已是最新版本",
    "about.statusUpdateAvailable": "发现新版本：{version}",
    "about.statusCheckFailed": "检查更新失败",
    "about.checkUpdates": "检查更新",
    "about.desktopUpdateTitle": "桌面端更新",
    "about.desktopUpdateAvailable": "发现新版本 v{version}",
    "about.desktopUpdateNotChecked": "尚未检查桌面端更新",
    "about.desktopInstallUpdate": "下载并安装更新",
    "about.desktopDownloading": "正在下载更新 {progress}",
    "about.desktopInstalling": "正在安装更新…",
    "about.desktopUpdateRestartNote": "安装时桌面端会退出，当前会话将中断。",
    "about.desktopUpdateConfirm": "安装桌面端 v{version}？应用将退出，正在运行的会话会中断。",
    "about.desktopUpdateError": "检查或安装更新失败：{error}",
    "about.updatePiAgent": "更新 Pi Agent",
    "about.updating": "正在更新…",
    "about.updateSuccess": "更新成功！",
    "about.updateSuccessDetail": "Pi Agent 已成功更新至 {version}。建议重启应用以使改动生效。",
    "about.updateFailed": "更新失败",
    "about.updateOutput": "更新日志",
    "about.updateScopeGlobal": "全局 CLI (npm -g)",
    "about.updateScopeLocal": "本地依赖",
    "about.updateTargetLabel": "更新目标",
    "about.repoInfo": "开源仓库与社区",
    "about.githubRepo": "GitHub 仓库",
    "about.releases": "版本发布 (Releases)",
    "about.issues": "问题反馈 (Issues)",
    "about.license": "开源协议",
    "about.systemInfo": "环境与系统信息",
    "about.nodeVersion": "Node.js 版本",
    "about.platform": "操作系统与架构",
    "about.cwd": "当前工作目录",
    "about.copyDiagnostics": "复制诊断信息",
    "about.diagnosticsCopied": "已复制诊断信息",
    "settings.title": "设置",
    "settings.general": "常规",
    ...
    "settings.tabAppearance": "外观与显示",
    "settings.tabAutomation": "自动化与会话",
    "settings.tabEnvironment": "工具与环境",
    "settings.fontSize": "字体大小",
    "settings.fontSizeDescription": "调整会话内容与界面的文本字体大小。",
    "settings.fontSizeSmall": "小",
    "settings.fontSizeMedium": "默认",
    "settings.fontSizeLarge": "大",
    "settings.fontSizeXLarge": "特大",
    "settings.hideThinking": "收起思考过程",
    "settings.hideThinkingDescription": "默认折叠会话中的思考细节，保持对话界面整洁。",
    "settings.autoCompaction": "自动压缩上下文",
    "settings.autoCompactionDescription": "当会话上下文接近上限时自动生成摘要并精简历史记录。",
    "settings.autoRetry": "网络失败自动重试",
    "settings.autoRetryDescription": "遇到网络抖动或上游 API 临时超载时自动重试请求。",
    "settings.quietStartup": "静默快速启动",
    "settings.quietStartupDescription": "减少会话开启时的冗长提示信息。",
    "settings.defaultReasoning": "默认思考强度",
    "settings.defaultReasoningDescription": "新创建会话时的初始思考推理级别。",
    "settings.projectTrust": "项目信任策略",
    ...
    "settings.desktopTailnetHint": "要让手机访问，请在本机安装 Tailscale 并执行一次以下命令。Serve 仅供 tailnet 使用；未加认证的 agent 服务切勿启用 Funnel。域名及安全配置详见 desktop/README.md。",
    "settings.closeBehaviorTray": "最小化到系统托盘",
    "settings.closeBehaviorQuit": "退出应用",
    "settings.enableSkillCommands": "启用技能斜杠命令",
    "settings.enableSkillCommandsDescription": "允许在输入框中通过 / 快速补全并调用已加载的技能。",
    ...
    "settings.modelScope": "模型范围",
    "modelScope.description": "勾选要在会话模型选择器（/model）中出现的模型。从未保存过选择时，所有可用模型都会出现；一旦保存，之后新接入供应商的模型默认不会出现，需要回到这里勾选。全部勾选并保存等同于不限制。",
    "modelScope.takeEffect": "保存后对新会话生效；进行中的会话在重新加载后生效。",
    "modelScope.searchPlaceholder": "搜索模型…",
    "modelScope.selectAll": "全选",
    "modelScope.clear": "清空",
    "modelScope.save": "保存",
    "modelScope.saving": "保存中…",
    "modelScope.saved": "已保存",
    "modelScope.emptySaveHint": "至少保留一个模型",
    "modelScope.loading": "正在加载模型…",
    "modelScope.noModels": "没有可用模型",
    "modelScope.unavailable": "暂时不可用",
    "modelScope.loadError": "模型列表加载失败",
    "modelScope.saveError": "保存失败",
    "modelScope.selectedCount": "已选 {selected}/{total}",
    "settings.projectRequired": "打开项目后才能配置此项",
    "settings.hiddenProjectsDescription": "从会话侧边栏隐藏的项目。恢复项目即可重新显示其会话。",
    "settings.noHiddenProjects": "暂无隐藏项目。",
    "settings.restoreProject": "恢复",
    "settings.selectHiddenProject": "请选择要管理的隐藏项目。",
    "settings.noSessionsForProject": "该项目下没有会话。",
    "settings.sessionHidden": "已隐藏",
    "settings.restoreSession": "恢复",
    "settings.removeProjectPermanently": "移除项目",
    ...
    "history.label": "完整历史",
  "history.openHtml": "打开 HTML",
  "history.downloadHtml": "下载 HTML",
  "history.downloadJsonl": "下载 JSONL",
    ...
    "system.label": "系统",
  "system.customTitle": "会话级覆盖",
  "system.customMode.append": "追加",
  "system.customMode.replace": "替换",
  "system.customAdd": "添加覆盖",
  "system.customEdit": "编辑",
  "system.customSave": "保存",
  "system.customClear": "清除",
  "system.customCancel": "取消",
  "system.customPlaceholder": "仅此会话生效的附加指令…",
  "system.customEmpty": "覆盖内容不能为空",
    "tools.label": "工具",
    "tools.title": "工具定义",
    ...
    "sidebar.refresh": "刷新",
  "sidebar.importSession": "导入会话 (.jsonl)",
    ...
    "sidebar.deleteSession": "隐藏 {title}？",
    "sidebar.hideSession": "隐藏会话",
    "sidebar.hideSessionShiftClick": "隐藏（按住 Shift 点击可跳过确认）",
    "sidebar.rename": "重命名",
    "sidebar.delete": "隐藏",
    "sidebar.deleteWithShiftClick": "隐藏（按住 Shift 点击可跳过确认）",
    ...
    "sidebar.earlier": "更早",
    "sidebar.sessionsHeading": "会话",
    "sidebar.collapseAll": "折叠全部工作区",
    "sidebar.expandAll": "展开全部工作区",
    "sidebar.manageList": "列表管理",
    "sidebar.searchSessions": "搜索会话...",
    "sidebar.projectOptions": "选项",
    "sidebar.newSessionHere": "在此处新建会话",
    "sidebar.copyPath": "复制路径",
    "sidebar.removeFromList": "隐藏项目",
    "sidebar.hideProject": "隐藏项目",
    "sidebar.removeProjectPermanently": "彻底移除项目",
    "sidebar.hiddenProjects": "已隐藏项目",
    "sidebar.noMatchingSessions": "未找到匹配的会话",
    "sidebar.openDirectory": "打开本地目录...",
    "sidebar.allProjects": "项目工程",
    "sidebar.newInProject": "在此项目新建会话",
    ...
    "files.mention": "提及",
    "files.download": "下载文件",
    "files.openWithSystem": "用系统默认程序打开",
    "files.openOptions": "更多打开方式",
    "files.openWithOther": "用其他应用打开…",
    "files.revealInExplorer": "在文件资源管理器中打开位置",
    "files.copyFullPath": "复制完整路径",
    "files.copyPathFailed": "复制路径失败",
    "files.openFileFailed": "无法打开文件：{error}",
    ...
    "chat.turnOutcome": "本轮成果",
    "chat.recordedCommands": "执行的命令（{count}）",
    "chat.commandFailures": "有命令执行失败",
    "chat.command.completed": "已完成",
    "chat.command.failed": "执行失败",
    "chat.command.unknown": "未记录结果",
    "chat.commandOutputTail": "仅显示最后 4,000 个字符，完整输出见执行过程。",
    "chat.commandNoOutput": "未记录输出",
  ...
  "chat.customTools": "自定义",
  "chat.customizeTools": "自定义组合…",
  "chat.customToolsBack": "返回预设",
  "chat.customToolsNone": "未选择任何工具 —— 等同于纯聊天",
  "chat.ephemeral": "临时会话",
  "chat.ephemeralHint": "内存会话：不写入磁盘的 JSONL 文件",
    ...
    "chat.commandClear": "新建空白会话",
    "chat.commandModel": "查看或切换模型",
    "chat.commandThinking": "设置思考级别 (auto/off/low/medium/high)",
    "chat.commandTools": "设置工具预设模式",
    "chat.commandSettings": "打开设置中心",
    "chat.commandHelp": "查看可用命令列表",
    "chat.compacted": "已压缩",
  ...
  "i18n.searchBranches": "搜索分支…",
  "i18n.labeledOnly": "只看书签",
  "i18n.addLabel": "添加书签",
  "i18n.editLabel": "编辑书签",
  "i18n.labelPlaceholder": "书签名称…",
  "i18n.saveLabel": "保存",
  "i18n.noLabels": "还没有书签",
    "i18n.source": "源代码",
    "i18n.preview": "预览",
    ...
    "dock.failed": "失败",
    "dock.queued": "等待中",
    "dock.noBash": "本会话中暂无后台 Bash 任务",
    "dock.noAgent": "暂无后台子代理",
    "dock.noProgress": "暂无计划任务",
    "dock.copy": "复制",
    "sidebar.showMore": "展开更多",
    "sidebar.showLess": "收起",
    "chat.contextUsage": "上下文用量",
    "chat.contextTokens": "Token 统计",
    "chat.inputTokens": "输入 Token",
    "chat.outputTokens": "输出 Token",
    "chat.cacheTokens": "缓存读取",
    "chat.estimatedCost": "费用预估",
  },
};
