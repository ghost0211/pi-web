...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "common.about": "關於",
    "about.title": "關於",
    "about.description": "Pi Web 與 Pi Agent 運行時版本資訊、更新檢測及開源項目。",
    "about.appInfo": "應用程式資訊",
    "about.appEditionDesktop": "桌面版",
    ...
    "about.cliNotInstalled": "未偵測到全域 CLI",
    "about.statusChecking": "正在檢查更新…",
    "about.statusUpToDate": "已是最新版本",
    "about.statusUpdateAvailable": "發現新版本：{version}",
    "about.statusCheckFailed": "檢查更新失敗",
    "about.checkUpdates": "檢查更新",
    "about.desktopUpdateTitle": "桌面版更新",
    "about.desktopUpdateAvailable": "發現新版本 v{version}",
    "about.desktopUpdateNotChecked": "尚未檢查桌面版更新",
    "about.desktopInstallUpdate": "下載並安裝更新",
    "about.desktopDownloading": "正在下載更新 {progress}",
    "about.desktopInstalling": "正在安裝更新…",
    "about.desktopUpdateRestartNote": "安裝時桌面版會結束，目前的會話將中斷。",
    "about.desktopUpdateConfirm": "安裝桌面版 v{version}？應用程式將結束，執行中的會話會中斷。",
    "about.desktopUpdateError": "檢查或安裝更新失敗：{error}",
    "about.updatePiAgent": "更新 Pi Agent",
    "about.updating": "正在更新…",
    "about.updateSuccess": "更新成功！",
    "about.updateSuccessDetail": "Pi Agent 已成功更新至 {version}。建議重啟應用程式以使變更生效。",
    "about.updateFailed": "更新失敗",
    "about.updateOutput": "更新日誌",
    "about.updateScopeGlobal": "全域 CLI (npm -g)",
    "about.updateScopeLocal": "本機相依性",
    "about.updateTargetLabel": "更新目標",
    "about.repoInfo": "開源倉庫與社群",
    "about.githubRepo": "GitHub 倉庫",
    "about.releases": "版本發佈 (Releases)",
    "about.issues": "問題回報 (Issues)",
    "about.license": "開源協議",
    ...
    "settings.tabAppearance": "外觀與顯示",
    "settings.tabAutomation": "自動化與會話",
    "settings.tabEnvironment": "工具與環境",
    "settings.fontSize": "字體大小",
    "settings.fontSizeDescription": "調整對話內容與介面的文字字體大小。",
    "settings.fontSizeSmall": "小",
    "settings.fontSizeMedium": "預設",
    "settings.fontSizeLarge": "大",
    "settings.fontSizeXLarge": "特大",
    "settings.hideThinking": "收起思考過程",
    "settings.hideThinkingDescription": "預設摺疊會話中的思考細節，保持對話介面整潔。",
    "settings.autoCompaction": "自動壓縮上下文",
    "settings.autoCompactionDescription": "當會話上下文接近上限時自動產生摘要並精簡歷史紀錄。",
    "settings.autoRetry": "網路失敗自動重試",
    "settings.autoRetryDescription": "遇到網路抖動或上游 API 臨時超載時自動重試請求。",
    "settings.quietStartup": "靜默快速啟動",
    "settings.quietStartupDescription": "減少會話開啟時的冗長提示資訊。",
    "settings.defaultReasoning": "預設思考強度",
    "settings.defaultReasoningDescription": "新建立會話時的初始思考推理等級。",
    "settings.projectTrust": "專案信任策略",
    ...
    "settings.desktopTailnetHint": "若要讓手機存取，請先在本機安裝 Tailscale 並執行一次以下命令。Serve 僅限 tailnet；未設定驗證的代理服務請勿使用 Funnel。網域及安全設定請參閱 desktop/README.md。",
    "settings.closeBehaviorTray": "最小化到系統匣",
    "settings.closeBehaviorQuit": "結束應用程式",
    "settings.enableSkillCommands": "啟用技能斜線指令",
    "settings.enableSkillCommandsDescription": "允許在輸入框中透過 / 快速補全並呼叫已載入的技能。",
    ...
    "settings.modelScope": "模型範圍",
    "modelScope.description": "勾選要在工作階段模型選擇器（/model）中出現的模型。從未儲存過選擇時，所有可用模型都會出現；一旦儲存，之後新接入供應商的模型預設不會出現，需要回到這裡勾選。全部勾選並儲存等同於不限制。",
    "modelScope.takeEffect": "儲存後對新工作階段生效；進行中的工作階段重新載入後生效。",
    "modelScope.searchPlaceholder": "搜尋模型…",
    "modelScope.selectAll": "全選",
    "modelScope.clear": "清空",
    "modelScope.save": "儲存",
    "modelScope.saving": "儲存中…",
    "modelScope.saved": "已儲存",
    "modelScope.emptySaveHint": "至少保留一個模型",
    "modelScope.loading": "正在載入模型…",
    "modelScope.noModels": "沒有可用模型",
    "modelScope.unavailable": "暫時不可用",
    "modelScope.loadError": "模型列表載入失敗",
    "modelScope.saveError": "儲存失敗",
    "modelScope.selectedCount": "已選 {selected}/{total}",
    "settings.projectRequired": "開啟專案後才能設定此項",
    "settings.hiddenProjectsDescription": "從工作階段側邊欄隱藏的專案。還原專案即可重新顯示其工作階段。",
    "settings.noHiddenProjects": "目前沒有隱藏的專案。",
    "settings.restoreProject": "還原",
    "settings.selectHiddenProject": "請選擇要管理的隱藏專案。",
    "settings.noSessionsForProject": "該專案下沒有工作階段。",
    "settings.sessionHidden": "已隱藏",
    "settings.restoreSession": "還原",
    "settings.removeProjectPermanently": "移除專案",
    ...
    "history.label": "完整紀錄",
  "history.openHtml": "開啟 HTML",
  "history.downloadHtml": "下載 HTML",
  "history.downloadJsonl": "下載 JSONL",
    ...
    "system.label": "系統",
  "system.customTitle": "工作階段覆寫",
  "system.customMode.append": "附加",
  "system.customMode.replace": "取代",
  "system.customAdd": "新增覆寫",
  "system.customEdit": "編輯",
  "system.customSave": "儲存",
  "system.customClear": "清除",
  "system.customCancel": "取消",
  "system.customPlaceholder": "僅此工作階段生效的附加指示…",
  "system.customEmpty": "覆寫內容不可為空",
    "tools.label": "工具",
    "tools.title": "工具定義",
  ...
  "sidebar.importSession": "匯入工作階段 (.jsonl)",
    ...
    "sidebar.deleteSession": "隱藏 {title}？",
    "sidebar.hideSession": "隱藏工作階段",
    "sidebar.hideSessionShiftClick": "隱藏（按住 Shift 點選可跳過確認）",
    "sidebar.today": "今天",
    "sidebar.yesterday": "昨天",
    "sidebar.last7Days": "前 7 天",
    "sidebar.earlier": "更早",
    "sidebar.sessionsHeading": "工作階段",
    "sidebar.collapseAll": "摺疊全部工作區",
    "sidebar.expandAll": "展開全部工作區",
    "sidebar.manageList": "列表管理",
    "sidebar.searchSessions": "搜尋對話...",
    "sidebar.projectOptions": "選項",
    "sidebar.newSessionHere": "在此處新增對話",
    "sidebar.copyPath": "複製路徑",
    "sidebar.removeFromList": "隱藏專案",
    "sidebar.hideProject": "隱藏專案",
    "sidebar.removeProjectPermanently": "徹底移除專案",
    "sidebar.hiddenProjects": "已隱藏專案",
    "sidebar.noMatchingSessions": "找不到符合的對話",
    "sidebar.openDirectory": "開啟本機目錄...",
    "sidebar.allProjects": "專案工程",
    "sidebar.newInProject": "在此專案建立新對話",
    "sidebar.rename": "重新命名",
    "sidebar.delete": "隱藏",
    "sidebar.deleteWithShiftClick": "隱藏（按住 Shift 點選可跳過確認）",
    ...
    "files.mention": "提及",
    "files.download": "下載檔案",
    "files.openWithSystem": "用系統預設程式開啟",
    "files.openOptions": "更多開啟方式",
    "files.openWithOther": "用其他應用程式開啟…",
    "files.revealInExplorer": "在檔案總管中顯示位置",
    "files.copyFullPath": "複製完整路徑",
    "files.copyPathFailed": "複製路徑失敗",
    "files.openFileFailed": "無法開啟檔案：{error}",
    ...
    "chat.turnOutcome": "本輪成果",
    "chat.recordedCommands": "執行的命令（{count}）",
    "chat.commandFailures": "有命令執行失敗",
    "chat.command.completed": "已完成",
    "chat.command.failed": "執行失敗",
    "chat.command.unknown": "未記錄結果",
    "chat.commandOutputTail": "僅顯示最後 4,000 個字元，完整輸出見執行過程。",
  ...
  "chat.customTools": "自訂",
  "chat.customizeTools": "自訂組合…",
  "chat.customToolsBack": "返回預設",
  "chat.customToolsNone": "未選取任何工具 —— 等同於純聊天",
  "chat.ephemeral": "暫時工作階段",
  "chat.ephemeralHint": "記憶體工作階段：不寫入磁碟的 JSONL 檔案",
    ...
    "chat.commandNew": "新增工作階段",
    "chat.commandClear": "新增空白工作階段",
    "chat.commandModel": "檢視或切換模型",
    "chat.commandThinking": "設定思考等級 (auto/off/low/medium/high)",
    "chat.commandTools": "設定工具模式",
  ...
  "i18n.searchBranches": "搜尋分支…",
  "i18n.labeledOnly": "只看書籤",
  "i18n.addLabel": "新增書籤",
  "i18n.editLabel": "編輯書籤",
  "i18n.labelPlaceholder": "書籤名稱…",
  "i18n.saveLabel": "儲存",
  "i18n.noLabels": "還沒有書籤",
    "i18n.source": "原始碼",
    "i18n.preview": "預覽",
    ...
    "dock.failed": "失敗",
    "dock.queued": "等待中",
    "dock.noBash": "本會話中暫無後台 Bash 任務",
    "dock.noAgent": "暫無後台子代理",
    "dock.noProgress": "暫無計劃任務",
    "dock.copy": "複製",
    "sidebar.showMore": "展開更多",
    "sidebar.showLess": "收起",
    "chat.contextUsage": "上下文用量",
    "chat.contextTokens": "Token 統計",
    "chat.inputTokens": "輸入 Token",
    "chat.outputTokens": "輸出 Token",
    "chat.cacheTokens": "快取讀取",
    "chat.estimatedCost": "費用預估",
  },
};
