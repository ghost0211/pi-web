...
test("merges consensus thinkingLevelMaps and disables divergent levels", () => {
  const merged = mergeThinkingLevelMaps([
    { off: null, minimal: null, low: "low", medium: null, high: "high", xhigh: null, max: null },
    { off: null, minimal: null, low: "low", medium: null, high: "high", xhigh: "xhigh", max: null },
  ]);
  assert.deepEqual(merged, {
    ...
    medium: null,
    high: "high",
    // Divergent: one entry says xhigh:null, the other xhigh:"xhigh".
    xhigh: null,
    max: null,
  });
